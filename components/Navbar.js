								...
								>
									...
									{user ? (
										...
										<img
											...
											src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
											alt=""
										/>
									)}
								</button>
								...
								{user ? (
									...
									<Link href="#" role="menuitem">
										<a
											...
											onClick={(e) => {
												e.preventDefault();
												auth.signinWithGoogle({ pathname: '/' });
											}}
										>
											Sign In
										</a>
